...
shading interp
colormap(flipud(jet))
contourf(vtotal,totalc,chi_array.*100,'edgecolor','none')
...
set(gca,'xcolor',[0 0 0],'ycolor',[0 0 0],'fontname','times',...
    'xminortick','on','yminortick','on','fontsize',12,'linewidth',1.5,'xtick',250:250:3000)
xlim([250,3000]);ylim([200,1e3])
